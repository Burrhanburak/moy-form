...
export default function PackageDetailClient({ package: packageData }: PackageDetailClientProps) {
        ...
        <div className="flex h-full w-full flex-col max-w-7xl">
          <div className="flex w-full flex-col gap-y-4 py-8 md:flex-row md:items-center md:justify-between">
            ...
            <div className="flex items-center gap-3">
              <Link 
                href="/dashboard/benefits/create-package"
              ...
              <Sheet open={isEditSheetOpen} onOpenChange={setIsEditSheetOpen}>
                ...
                <button className="flex items-center justify-center rounded-xl border border-white/10 bg-[#171719] px-4 py-2 text-sm font-medium text-white transition-opacity hover:opacity-90 focus:outline-none focus:ring-0 focus:ring-offset-0">
                    <div className="flex flex-row items-center">Edit Package</div>
                  </button>
                </SheetTrigger>
                <SheetContent 
                      ...
                      <form>
                        ...
                        <div className="space-y-4">
                          <div className="flex flex-col gap-2">
                            <label className="text-sm font-medium">Package Adı</label>
                            <input 
                              name="name"
                              type="text" 
                        ...
                        <div className="space-y-4 pt-4 border-t dark:border-white/10">
                          <h3 className="text-sm font-semibold text-gray-900 dark:text-white">Site Detayları</h3>
                          ...
                          <div className="grid grid-cols-2 gap-3">
                            <div className="flex flex-col gap-2">
                              <label className="text-sm font-medium">Revizyon Hakkı</label>
                              <input 
                                name="revisionCount"
                                type="number" 
                            ...
                            <div className="flex flex-col gap-2">
                              <label className="text-sm font-medium">Teslim Süresi (Gün)</label>
                              <input 
                                name="deliveryTimeInDays"
                                type="number" 
                                defaultValue={packageData.deliveryTimeInDays || ""}
                                placeholder="30"
                                min="1"
                                className="w-full p-3 border rounded-xl dark:bg-[#171719] dark:border-white/10"
                              />
                        ...
                        {/* Reference Links */}
                        <div className="space-y-4 pt-4 border-t dark:border-white/10">
                          <h3 className="text-sm font-semibold text-gray-900 dark:text-white">Referans ve Görseller</h3>
                          
                          <div className="flex flex-col gap-2">
                            <label className="text-sm font-medium">Referans Site URL&apos;leri</label>
                            <textarea 
                              name="referenceUrls"
                            ...
                            />
                            <p className="text-xs text-gray-500">Beğendiğiniz site örneklerinin linklerini ekleyin</p>
                          </div>

                          <div className="flex flex-col gap-2">
                            <label className="text-sm font-medium">Görsel URL&apos;leri</label>
                            <textarea 
                              ...
                              className="w-full p-3 border rounded-xl h-20 text-sm dark:bg-[#171719] dark:border-white/10"
                            />
                            <p className="text-xs text-gray-500">Referans tasarım görsellerinin linklerini ekleyin</p>
                          </div>
                        </div>

                        {/* Features & Maintenance */}
                        <div className="space-y-4 pt-4 border-t dark:border-white/10">
                          <h3 className="text-sm font-semibold text-gray-900 dark:text-white">Özellikler ve Bakım</h3>
                        ...
                        {/* Special Notes */}
                        <div className="space-y-4 pt-4 border-t dark:border-white/10">
                          <h3 className="text-sm font-semibold text-gray-900 dark:text-white">Özel Notlar</h3>
                          
                          <div className="flex flex-col gap-2">
                            <label className="text-sm font-medium">Ekstra İstekler ve Notlar</label>
                            <textarea 
                              name="specialNotes"
          ...
          <div className="flex w-full flex-col gap-y-4 pb-8">
            ...
            <div className="flex w-full flex-col divide-y divide-gray-200 rounded-xl border border-gray-200 bg-transparent p-0 dark:divide-gray-700 dark:border-[#313131] dark:bg-[#171719] md:rounded-3xl lg:rounded-4xl">
              <div className="flex flex-col gap-6 p-4 md:p-8">
                <div className="flex flex-col gap-4 md:gap-1">
                  ...
                  <div className="flex flex-col gap-4">
                    <div>
                      <h4 className="text-sm font-medium">{packageData.name}</h4>
                      <p className="text-sm text-green-600">{formatPrice(packageData.price)}</p>
                    </div>
                    <div>
              ...
              <div className="flex flex-col gap-6 p-4 md:p-8">
                <div className="flex flex-col gap-4 md:gap-1">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <h4 className="text-sm font-medium mb-1">Number of Pages</h4>
                      <p className="text-sm text-gray-600 dark:text-gray-400">{packageData.numberOfPages || 'Not specified'}</p>
                    </div>
                    <div>
                    ...
                    <div>
                      <h4 className="text-sm font-medium mb-1">Revision Count</h4>
                      <p className="text-sm text-gray-600 dark:text-gray-400">{packageData.revisionCount || 'Not specified'}</p>
                    </div>
                    <div>
                      <h4 className="text-sm font-medium mb-1">Delivery Time</h4>
                      <p className="text-sm text-gray-600 dark:text-gray-400">
                        {packageData.deliveryTimeInDays ? `${packageData.deliveryTimeInDays} days` : 'Not specified'}
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="flex flex-col gap-6 p-4 md:p-8">
                <div className="flex flex-col gap-4 md:gap-1">
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      <h4 className="text-sm font-medium mb-1">Maintenance Required</h4>
                      <p className="text-sm text-gray-600 dark:text-gray-400">
                        {packageData.maintenanceRequired ? 'Yes' : 'No'}
                        {packageData.maintenanceRequired && packageData.maintenancePrice && (
                          <span className="ml-2">- {packageData.maintenancePrice}₺/month</span>
                        )}
                      </p>
                    </div>
                  </div>
            ...
            {/* Reference Links */}
            {(packageData.referenceUrls.length > 0 || packageData.referenceImages.length > 0) && (
              <div className="flex w-full flex-col divide-y divide-gray-200 rounded-xl border border-gray-200 bg-transparent p-0 dark:divide-gray-700 dark:border-[#313131] dark:bg-[#171719] md:rounded-3xl lg:rounded-4xl">
                <div className="flex flex-col gap-6 p-4 md:p-8">
                  <div className="flex flex-col gap-4 md:gap-1">
                    ...
                    <div className="space-y-4">
                      {packageData.referenceUrls.length > 0 && (
                        <div>
                          <h4 className="text-sm font-medium mb-2">Reference URLs</h4>
                          <ul className="space-y-1">
                            {packageData.referenceUrls.map((url, index) => (
                              <li key={index}>
                                <a href={url} target="_blank" rel="noopener noreferrer" className="text-gray-800 hover:text-gray-600 dark:text-white/80 dark:hover:text-white">
                                  {url}
                                </a>
                              </li>
                            ))}
                      ...
                      {packageData.referenceImages.length > 0 && (
                        <div>
                          <h4 className="text-sm font-medium mb-2">Reference Images</h4>
                          <ul className="space-y-1">
                            {packageData.referenceImages.map((image, index) => (
                              <li key={index}>
                                <a href={image} target="_blank" rel="noopener noreferrer" className="text-gray-800 hover:text-gray-600 dark:text-white/80 dark:hover:text-white">
                                  {image}
                                </a>
                              </li>
                            ))}
                  ...
                  <div className="flex flex-col gap-4 md:gap-1">
                    ...
                    <div className="space-y-4">
                      <div>
                        ...
                        <p className="text-sm text-gray-600 dark:text-gray-400">{packageData.specialNotes}</p>
                      </div>
                      <div>
                        <h4 className="text-sm font-medium mb-1">Custom Request</h4>
                        <p className="text-sm text-gray-600 dark:text-gray-400">
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="flex flex-col gap-2">
                  <div className="flex justify-between">
                    ...
                    <span className="text-sm font-medium">{formatPrice(packageData.price)}</span>
                  </div>
                  {packageData.maintenanceRequired && packageData.maintenancePrice && (
                    <div className="flex justify-between">
                      <span className="text-sm text-gray-600 dark:text-gray-400">Monthly Maintenance</span>
                      <span className="text-sm font-medium">₺{packageData.maintenancePrice}</span>
                    </div>
                  )}
                  <div className="border-t pt-3">
                    <div className="flex justify-between font-semibold">
                      <span className="text-sm">Total</span>
                      <span className="text-sm">{formatPrice(packageData.price)}</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="space-y-3 text-sm">
                  <div>
                    ...
                    <p className="text-sm font-medium">{formatDate(packageData.createdAt)}</p>
                  </div>
                  <div>
                    <span className="text-sm text-gray-600 dark:text-gray-400">Last Updated</span>
                    <p className="text-sm font-medium">{formatDate(packageData.updatedAt)}</p>
                  </div>
                  <div>
                    <span className="text-sm text-gray-600 dark:text-gray-400">Package ID</span>
                    <p className="text-sm font-medium font-mono">{packageData.id}</p>
                  </div>
                </div>
              </div>
            </div>
